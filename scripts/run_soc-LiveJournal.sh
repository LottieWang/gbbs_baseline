...
declare undir_graph="/ssd1/graphs/bench_experiments/soc-LiveJournal1_sym.adj"
declare dir_graph="/ssd1/graphs/bench_experiments/soc-LiveJournal1.adj"
declare unwgh_graph=${undir_graph}
declare wgh_graph="/ssd1/graphs/bench_experiments/soc-LiveJournal1_sym_W.adj"

declare bench_path="../benchmark/"
declare mmap=true

declare datadir="timings/"
declare graphdir="${datadir}soc-LiveJournal1/"
